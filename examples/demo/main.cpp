...
void loop()
{
	...
	//////////////////////Partial update time demo/////////////////////////////////////
			...
			EPD_Dis_Part_TwoData(376,24,Num[3],Num[0],2,104,48,0); //x,y,DATA-A~E,Resolution 48*104      
			EPD_Dis_Part_TwoData(376+48*4+24,24,Num[5],Num[4],2,104,48,0); //x,y,DATA-A~E,Resolution 48*104

			
			EPD_Dis_Part_TwoData(376,24,Num[3],Num[1],2,104,48,0); //x,y,DATA-A~E,Resolution 48*104      
			EPD_Dis_Part_TwoData(376+48*4+24,24,Num[5],Num[5],2,104,48,0); //x,y,DATA-A~E,Resolution 48*104  	
