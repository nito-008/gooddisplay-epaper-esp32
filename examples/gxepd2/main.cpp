...
void drawBitmaps800x480()
{
  ...
  if ((display.epd2.WIDTH == 800) && (display.epd2.HEIGHT == 480) && !display.epd2.hasColor)
  {
    ...
    {
      display.drawImage(Bitmap800x480_5, 0, 0, 800, 480, false, true, true);
      delay(2000);
      display.drawImage(Bitmap800x480_6, 0, 0, 800, 480, false, true, true);
      delay(2000);
      display.drawImage(Bitmap800x480_7, 0, 0, 800, 480, false, true, true);
      delay(2000);
      display.drawImage(Bitmap800x480_8, 0, 0, 800, 480, false, true, true);
      delay(2000);
      display.drawImage(Bitmap800x480_9, 0, 0, 800, 480, false, true, true);
      delay(2000);
    }
#endif
...
void setup()
{
  ...
  {
    display.fillScreen(GxEPD_WHITE);
    display.drawBitmap(0, 0, Bitmap_Human, 800, 480, GxEPD_BLACK);
  } while (display.nextPage());
